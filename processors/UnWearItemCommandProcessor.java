...
public class UnWearItemCommandProcessor
  implements RequestCommandProcessor
{
  ...
  public Response process(HashMap params, Server server)
    throws IOException
  {
    Response response = new Response("UNWEARWARDOBE");
    ...
    if (status == 1)
    {
      ...
      if (status == 2) {
        unWearWardobe(currentPlayer, item);
  ...
  private void unWearWardobe(Player currentPlayer, WardobeItem item) {
